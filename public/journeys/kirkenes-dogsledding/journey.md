---
id: 165UZHSmki_zSBLnWBZR3
slug: kirkenes-dogsledding
title: Running with the Pack
subtitle: Dog Sledding in Arctic Norway
description: Two months working as a dog sledding guide in Kirkenes, where the Arctic winter teaches patience and the huskies teach everything else.
...
# Tags
tags: [dog-sledding, arctic, norway, work, winter]
...
waypoints:
  - id: kirkenes
    ...
    country: Norway
    date: 2016-01-15
    weather: { condition: snow, temp: -15 }
  ...
  - id: grense-jakobselv
    name: Grense Jakobselv
    lat: 69.7833
    lon: 30.7500
    country: Norway
    date: 2016-02-15
    weather: { condition: clear-night, temp: -18 }
---
...
Kirkenes sits at the edge of everything. Russia is a few kilometers east. Finland a short drive south. The Barents Sea stretches north into darkness. In January, the sun doesn't rise at all.
...
Two months of frozen mornings and tired muscles. Two months of learning a language that isn't spoken. The dogs don't care where you're from or what you've done. They care if you show up. They care if you're honest.
